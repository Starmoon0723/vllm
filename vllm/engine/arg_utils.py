...
class EngineArgs:
    ...
    video_divprune_exact_threshold: int = (
        MultiModalConfig.video_divprune_exact_threshold
    )
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        multimodal_group.add_argument(
            "--video-pruning-method", **multimodal_kwargs["video_pruning_method"]
        )
        multimodal_group.add_argument(
            "--video-divprune-exact-threshold",
            **multimodal_kwargs["video_divprune_exact_threshold"],
        )
        multimodal_group.add_argument(
